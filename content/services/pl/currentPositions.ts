...
export const SERVICES_PL: Position[] = [
	{
		title: 'Backend',
		description:
			'Odpowiedni dobór technologii do projektu jest niezbędny. Decyzja o technologii backendu Twojej aplikacji lub strony internetowej będzie miała wpływ na Ciebie przez długi czas, dlatego ważne jest, aby dobrze to przemyśleć. Backend postrzegamy jako rdzeń działania Twojej firmy, miejsce, w którym odbywają się najważniejsze procesy i generowana jest wartość. \n\n' +
