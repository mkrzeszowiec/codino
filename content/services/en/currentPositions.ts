...
export const SERVICES_EN: Position[] = [
	...
	},
	{
		...
		description:
			...
			'We select frameworks and tools to meet business requirements and modern standards. Using modern technologies, we ensure that your application will be fast, easy to use and, above all, beautiful. We can be an independent team or part of a development team.',
		shortDescription: '',
		slug: 'frontend',
