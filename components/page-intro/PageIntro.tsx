            ...
            <div className="container">
                <div className="page-intro__content">
                    ...
                    <h3 className="page-intro__subtitle">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto assumenda dignissimos
                        dolorum pariatur quis soluta sunt temporibus ut, veniam? Accusantium dolorem exercitationem
