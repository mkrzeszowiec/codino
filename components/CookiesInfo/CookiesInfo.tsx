const CookiesInfo = () => {
	return (
		<div className="cookiesInfo">
			<h2 className="cookiesInfo__title">§ 1 Definicje</h2>
			<ul>
				<li>
					<p>
				...
				<li>
					<p>
						<strong>Serwis zewnętrzny</strong> - serwis internetowe partnerów, usługodawców lub usługobiorców
						Administratora
					</p>
				</li>
				<li>
					<p>
						...
						<span id="firma">
							<span className="colored">CODINO Sp. z o.o.</span>, prowadząca działalność pod adresem:{' '}
							<span className="colored">ul. Ludwika Narbutta 53/6, 02‐529 Warszawa</span>, o nadanym numerze
							identyfikacji podatkowej (NIP): <span className="colored">5213952796</span>
						</span>
						, świadcząca usługi drogą elektroniczną za pośrednictwem Serwisu oraz przechowująca i uzyskująca dostęp do
						informacji w urządzeniach Użytkownika
					</p>
				</li>
				<li>
					<p>
						<strong>Użytkownik</strong> - osba fizyczna, dla której Administrator świadczy usługi drogą elektroniczna za
						pośrednictwem Serwisu.
					</p>
				</li>
				<li>
					<p>
						<strong>Urządzenie</strong> - elektroniczne urządzenie wraz z oprogramowaniem, za pośrednictwem, którego
						Użytkownik uzyskuje dostęp do Serwisu
					</p>
				</li>
				<li>
					<p>
						<strong>Cookies (ciasteczka)</strong> - dane tekstowe gromadzone w formie plików zamieszczanych na
						Urządzeniu Użytkownika
					</p>
				</li>
			</ul>
			<h2 className="cookiesInfo__title">§ 2 Rodzaje Cookies</h2>
			<ul>
				<li>
					<p>
						<strong>Cookies wewnętrzne</strong> - pliki zamieszczane i odczytywane z Urządzenia Użytkownika przes system
						teleinformatyczny Serwisu
					</p>
				</li>
				<li>
					<p>
						<strong>Cookies zewnętrzne</strong> - pliki zamieszczane i odczytywane z Urządzenia Użytkownika przez
						systemy teleinformatyczne Serwisów zewnętrznych
					</p>
				</li>
				<li>
					<p>
						<strong>Cookies sesyjne</strong> - pliki zamieszczane i odczytywane z Urządzenia Użytkownika przez Serwis{' '}
						<span id="sz1" className="inline">
							lub Serwisy zewnętrzne
						</span>{' '}
						podczas jednej sesji danego Urządzenia. Po zakończeniu sesji pliki są usuwane z Urządzenia Użytkownika.
					</p>
				</li>
				<li>
					<p>
						<strong>Cookies trwałe</strong> - pliki zamieszczane i odczytywane z Urządzenia Użytkownika przez Serwis{' '}
						<span id="sz2" className="inline">
							lub Serwisy zewnętrzne
						</span>{' '}
						do momentu ich ręcznego usunięcia. Pliki nie są usuwane automatycznie po zakończeniu sesji Urządzenia chyba
						że konfiguracja Urządzenia Użytkownika jest ustawiona na tryb usuwanie plików Cookie po zakończeniu sesji
						Urządzenia.
					</p>
				</li>
			</ul>

			<h2 className="cookiesInfo__title">§ 3 Bezpieczeństwo</h2>
			<ul>
				<li>
					<p>
						<strong>Mechanizmy składowania i odczytu</strong> - Mechanizmy składowania i odczytu Cookies nie pozwalają
						na pobierania jakichkolwiek danych osobowych ani żadnych informacji poufnych z Urządzenia Użytkownika.
						Przeniesienie na Urządzenie Użytkownika wirusów, koni trojańskich oraz innych robaków jest praktynie
						niemożliwe.
					</p>
				</li>
				<li>
					<p>
						<strong>Cookie wewnętrzne</strong> - zastosowane przez Administratora Cookie wewnętrzne są bezpieczne dla
						Urządzeń Użytkowników
					</p>
				</li>
				<li>
					<p>
						<strong>Cookie zewnętrzne</strong> - za bezpieczeństwo plików Cookie pochodzących od partnerów Serwisu
						Administrator nie ponosi odpowiedzialności. Lista partnerów zamieszczona jest w dalszej części Polityki
						Cookie.
					</p>
				</li>
			</ul>

			<h2 className="cookiesInfo__title">§ 4 Cele do których wykorzystywane są pliki Cookie</h2>
			<ul id="cele">
				<li>
					<p>
						<strong>
							<span className="colored">Usprawnienie i ułatwienie dostępu do Serwisu</span>
						</strong>{' '}
						- Administrator może przechowywać w plikach Cookie informacje o prefernecjach i ustawieniach użytkownika
				...
				<li>
					<p>
						...
						- Administrator{' '}
						<span id="sz4" className="inline">
							oraz Serwisy zewnętrzne
						</span>{' '}
						wykorzystuje pliki Cookie do zbirania i przetwarzania danych statystycznych takich jak np. statystyki
						odwiedzin, statystyki Urządzeń Użytkowników czy statystyki zachowań użytkowników. Dane te zbierane są w celu
						analizy i ulepszania Serwisu.
					</p>
				</li>
			</ul>
			<h2 className="cookiesInfo__title">§ 5 Serwisy zewnętrzne</h2>
			<p id="zewinfo">
			...
			<ul>
				...
				<li>
					<p>
						...
						mobilnych dostępna są na stronie: <a href="http://jakwylaczyccookie.pl">jak wyłączyć cookie</a>.
					</p>
				</li>
				<li>
					<p>
			...
			<h2 className="cookiesInfo__title">§ 7 Wyłączenie odpowiedzialności</h2>
			<ul>
				<li>
			...
			<h2 className="cookiesInfo__title">§ 8 Wymagania Serwisu</h2>
			<ul>
				<li>
					<p>
			...
			<h2 className="cookiesInfo__title">§ 9 Zmiany w Polityce Cookie</h2>
			<ul>
				<li>
					<p>
